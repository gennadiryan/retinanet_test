...
class RetinaNet(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._generalized_box_iou = generalized_box_iou
    ...
    def compute_loss(self, targets, head_outputs, anchors):
        ...
        for anchors_per_image, targets_per_image in zip(anchors, targets):
            ...
            match_quality_matrix = box_ops.box_iou(targets_per_image["boxes"], anchors_per_image) if not self._generalized_box_iou else box_ops.generalized_box_iou(targets_per_image['boxes'], anchors_per_image)
    ...
    def postprocess_detections(self, head_outputs, anchors, image_shapes):
        ...
        for index in range(num_images):
            ...
            keep = box_ops.batched_nms(image_boxes, image_scores, image_labels, self.nms_thresh) if self._batched_nms else box_ops.nms(image_boxes, image_scores, self.nms_thresh)
